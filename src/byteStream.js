 ...
 *  var byteStream = new ByteStream(littleEndianByteArrayParser, byteArray);
 *
 * */
 ...
 */
var ByteStream = function (byteArrayParser, byteArray, position) {
  if (byteArrayParser === undefined) {
    throw "missing required parameter 'byteArrayParser'";
  }
  ...
  if ((byteArray instanceof Uint8Array) === false &&
    ...
    throw 'ByteStream: parameter byteArray is not of type Uint8Array or Buffer';
  }
  if (position < 0) {
    throw "parameter 'position' cannot be less than 0";
  }
  if (position >= byteArray.length) {
    throw "parameter 'position' cannot be greater than or equal to 'byteArray' length";
