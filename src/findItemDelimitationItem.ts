 ...
 * @param element
 */
const findItemDelimitationItemAndSetElementLength = (byteStream: IByteStream, element: IDataSetElement):void => {
...
export default findItemDelimitationItemAndSetElementLength;
